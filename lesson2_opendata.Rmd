...
.footnote[[CNIL & CADA's Open Data Practical Guide, *in French*](https://www.cnil.fr/sites/default/files/atoms/files/guide_open_data.pdf)]
...
.center[<img src="./img/rawdatanow.png" height="400" />]

[Start the Ted talk at 09:00](https://www.ted.com/talks/tim_berners_lee_on_the_next_web#t-535280)
...
--
**This doesn't include private/individual informations or data that may harm the national security**
...
---
## Open Data benefits : Innovation

- L’ouverture des donnée, moyen de valoriser le travail de l’administration

- L’ouverture des données, moyen de servir l’intérêt général

- L’ouverture des données, moyen de gagner du temps (et de l’argent)

- L’ouverture des données, moyen d’enrichir le travail de l’administration

> 80% des téléchargements sur le portail open data provenaient des services de la ville

Paris 2013 Report 

---
## Open Data benefits : Modernisation

- L’open data, levier de qualité des données
  - Au niveau des SI, ouvrir des données peut permettre d’améliorer leur qualité
  - Découvertes d’erreurs, de coquilles, d’approximations pas détectées en interne
Ex : emplacement des arrêts de bus à Rennes

- L’open data, opportunité pour trouver de nouvelles données
  - Phase d’identification des données en amont de l’ouverture
  - Cartographie du système d’information permet d’identifier de nouveaux fichiers
  - Détecter des données stratégiques qui sont gérées en dehors du SI

- L’open data, révélateur d’enjeux liés à la souveraineté du SI
  - Phase d’ouverture des données
  - Les agents se heurtent à des SI qui n’ont pas été prévus pour l’ouverture
(export/Négocier avec des prestataires des prestations spécifiques

---
## Open Data benefits : Transparency

See slides on Open Government

---
## Open Data benefits : Economic perspective

> Between 2016 and 2020, the size of the open data market is expected to increase by
36.9%, to reach a value of 75.7 billion euros in 2020

EU Commission Report « Creating Value through Open Data » Nov 2015

.center[<img src="./img./arketsize.png" height="200" />]

---
## Open data : key milestones
...
[Datagora](https://datagora.fr) is a French initiative that aims to gather different type of official reliable sources in one non-profit making platform called Datagora.
...
.center[<img src="./img/datagora1.png" height = "350" />]

---

## Datagora

To make the web platform sustainable we have recently developed a media activity which valorizes studies, statistics or reports with social media contents such as infographics or short videos. Example :
.center[[<img src="./img/datagora2.png" height = "400"s />](https://twitter.com/RSF_inter/status/1124213498756595713)]
...
.center[<img src="./img/googledataset.png" height="350"/>]

Read [Simon Chignard's article](https://donneesouvertes.info/2018/09/17/jai-teste-google-dataset-search-le-moteur-de-recherche-open-data/) on Google Dataset Search
